...
bool EventTypeCondition::Init(const Json::Value& config, const CollectionPipelineContext& ctx) {
    string errorMsg;
    string value;
...
bool TagCondition::Init(const Json::Value& config, const CollectionPipelineContext& ctx) {
    string errorMsg;
...
bool Condition::Init(const Json::Value& config, const CollectionPipelineContext& ctx) {
    string errorMsg;
